function minicalendar(option) {
  this.__option = $.extend({
    weekStart: 0,
    weekName: [i18n.minicalendar.dateformat.sun, i18n.minicalendar.dateformat.mon, i18n.minicalendar.dateformat.tue, i18n.minicalendar.dateformat.wed, i18n.minicalendar.dateformat.thu, i18n.minicalendar.dateformat.fri, i18n.minicalendar.dateformat.sat],
    //星期的格式
    monthName: [i18n.minicalendar.dateformat.jan, i18n.minicalendar.dateformat.feb, i18n.minicalendar.dateformat.mar, i18n.minicalendar.dateformat.apr, i18n.minicalendar.dateformat.may, i18n.minicalendar.dateformat.jun, i18n.minicalendar.dateformat.jul, i18n.minicalendar.dateformat.aug, i18n.minicalendar.dateformat.sep, i18n.minicalendar.dateformat.oct, i18n.minicalendar.dateformat.nov, i18n.minicalendar.dateformat.dec],
    //月份的格式
  ...
  __initevent: function() {
    ...
    aprev.click(function() {
      ...
      if (me.__option.onchange) {
        me.__option.onchange.call(me, me.__option.currentDate, true);
      }
    });
