        ...
        _onTimeChange: function () {
            ...
            if (this.$timeObj) {
                if (pickerTimeFormat === o.timeFormat) {
                    var val = this.formattedTime;

                    /*if (this.$input.attr('schedule') === 'schedule') {
                        if (val.slice(3, 5) !== '00') {
                            val = val.slice(0, 3) + '30:00';
                        }
                    }*/

                    this.$timeObj.text(val + pickerTimeSuffix);
                }
                else {
    ...
    */
    ...
    $.datepicker._gotoToday = function (id) {
        ...
        var sysTime = $(".sysTime", top.frames["frameContainer"].document).text(),
            ...
            datepicker, year, month, day, hour, minute, now;
