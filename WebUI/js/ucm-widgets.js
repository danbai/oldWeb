(function ($) {
    ...
    $.widget("ucm.modelDevices", {
        ...
        _rebuildWidgets: function () {
            ...
            $.each(self._.items, function (index, item) {
                ...
                item.modelWidget.css("width", itemWidth);
    ...
    $.widget("ucm.navibox", {
        ...
        _autocompleteSelect: function (event, ui) {
            ...
            autocomplete.lastItem = jQuery.extend({}, ui.item);

            this.expandWidget(ui.item);

            var e = jQuery.Event("naviEvent");
    ...
    $.widget("ucm.fieldItem", {
        ...
        _destroy: function () {
            ...
            if (item._widget) {
                ...
                var e = jQuery.Event("itemDestoryEvent");
                e.originator = item;
