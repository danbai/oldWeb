...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_common.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_info.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_invite.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_message.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_options.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_publish.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_register.js',
        '../js' + version + '/src/tinySIP/src/api/tsip_api_subscribe.js'
    );
}