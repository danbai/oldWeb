...
if (!window.__b_release_mode) {
    tsip_api_add_js_scripts('head',
        '../js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__client.js',
        '../js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__ect.js',
        '../js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__hold.js',
        '../js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__server.js',
        '../js' + version + '/src/tinySIP/src/dialogs/tsip_dialog_invite__timers.js'
    );
}