...
if (!window.__b_release_mode) {
    tmedia_api_add_js_scripts('head',
        '../js' + version + '/src/tinyMEDIA/src/tmedia_session_jsep.js',
        '../js' + version + '/src/tinyMEDIA/src/tmedia_session_roap.js',
        '../js' + version + '/src/tinyMEDIA/src/tmedia_session_ghost.js'
    );
}