...
// ================== DEBUG CODE =============== //
var UCMGUI = top.UCMGUI,
    config = UCMGUI.config,
    version = "_" + config.model_info.prog_version.replace(/\./g, '_');
var __b_release_mode = false;
var tag_hdr = document.getElementsByTagName('head')[0];
['../js' + version + '/SIPml.js', '../js' + version + '/src/tinySIP/src/tsip_api.js'].forEach(function(file) {
