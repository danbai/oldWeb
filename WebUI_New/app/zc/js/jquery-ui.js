...
$.widget( "ui.autocomplete", {
    ...
    _create: function() {
        ...
        this._on( this.element, {
            ...
            focus: function() {
                //this.selectedItem = null;     /* Changed by WL; This line will cause "Add option" in ucm.navibox not working, cause selectedItem is null */
...
$.widget( "ui.dialog", {
    ...
    _createTitlebar: function() {
        ...
        this.uiDialogTitlebarClose = $("<button></button>")
            ...
            .attr({"title": top.$.lang("LANG223"), "localeTitle": "LANG223"})
