...
var CGI_PATH = window.location.protocol + '//' + window.location.host + '/cgi'
...
function errorHandler (data, callback) {
    var bool = true;
            ...
            checkZeroConfigInvalidModels: function(source, flagJump) {
                $.ajax({
                    ...
                    success: function(result) {
                        var bool = errorHandler(result, function () {
                        });
                        if (bool) {
                            ...
                            if (numOfInvalidModel > 0) {
                                ...
                                var dissmiss_warning =  'no' // top.$.cookie('dismiss_zcmodel_missing_warning');
