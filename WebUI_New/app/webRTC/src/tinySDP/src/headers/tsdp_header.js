...
if (!window.__b_release_mode) {
    tsdp_api_add_js_scripts('head',
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_A.js',
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_C.js',
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_M.js',
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_O.js',
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        '../js' + version + '/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}