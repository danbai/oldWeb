...
// add tinySAK API
tsdp_api_add_js_scripts('head', '../js' + version + '/src/tinySAK/src/tsk_api.js');

tsdp_api_add_js_scripts('head',
    '../js' + version + '/src/tinySDP/src/headers/tsdp_header.js',
    ...
    '../js' + version + '/src/tinySDP/src/tsdp_message.js'
