        ...
        this.props.form.validateFieldsAndScroll((err, values) => {
            ...
            if (confirmStr) {
                Modal.confirm({
                    ...
                    onOk: this._doSubmit.bind(this, action)
                })
            } else {
                this._doSubmit(action)
            }
        })
    }
    _doSubmit = (action) => {
    ...
    render() {
        ...
        return (
            <div className="app-content-main" id="app-content-main">
                <Title headerTitle={ mode === "addSip" ? formatMessage({id: "LANG2908"}) : formatMessage({id: "LANG2909"}) } onSubmit={ this._handleSubmit.bind(this) } onCancel={ this._handleCancel } isDisplay='display-block' />
                    ...
                    <Form tab={formatMessage({id: "LANG2217"})} key="1">
                            ...
                            { getFieldDecorator('host', {
                                ...
                                rules: [{
                                    ...
                                    validator: (data, value, callback) => {
                                       ...
                                       /*
                                        Validator.specialhost(data, value, callback, formatMessage, rightIpMsg)
                                        */
                                        Validator.host(data, value, callback, formatMessage, hostName)
                                    }
                                }, {
                                    validator: (data, value, callback) => {
                                        let hostName = formatMessage({
                        ...
                        <FormItem
                            ...
                            { getFieldDecorator('cidnumber', {
                                ...
                                rules: [{
                                    validator: (data, value, callback) => {
                                        this.state.trunkType === "peer" ? Validator.calleridSip(data, value, callback, formatMessage) : callback()
                                    }
                                }, {
                                    validator: (data, value, callback) => {
                                        this.state.trunkType === "peer" ? this._checkCidnumberRequired(data, value, callback, formatMessage) : callback()
                                    }
                                }],
                                initialValue: ""
                            })(
                        ...
                        <FormItem
                            ...
                            { getFieldDecorator('fromdomain', {
                                ...
                                rules: [{
                                    validator: (data, value, callback) => {
                                        Validator.host(data, value, callback, formatMessage, formatMessage({id: "LANG1369"}))
                                    }
                                }],
                                initialValue: ""
                            })(
