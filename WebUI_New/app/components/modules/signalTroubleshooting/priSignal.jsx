...
class Prisignal extends Component {
    constructor(props) {
        super(props)
    ...
    _getPri = () => {
        $.ajax({
            ...
            type: "post",
            data: {
                'action': 'pri_signaling_trace_query',
                'pri_trace_switch': ''
            },
            error: function(e) {
    ...
    _download = () => {
        window.open(api.apiHost + "action=downloadFile&type=pri_signaling_trace", '_self')
    }
    _delete = () => {
        $.ajax({
            url: api.apiHost,
...
export default Form.create()(injectIntl(Prisignal))