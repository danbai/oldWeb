...
class LoginSetting extends Component {
    ...
    render() {
        ...
        if (this.props.loginLoad) {
            this._getInitData()
            this.props.setLoadFunc('loginLoad', false)
        }
        ...
        document.title = formatMessage({id: "LANG584"}, {0: model_info.model_name, 1: formatMessage({id: "LANG3965"})})
