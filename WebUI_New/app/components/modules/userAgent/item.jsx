...
import { Button, Card, Col, Menu, Dropdown, Form, Icon, Input, message, Modal, Row, Select, Table, Tag, Tooltip } from 'antd'
...
class SwitchBoardItem extends Component {
    ...
    _createAnswerOptions = (text, record, index) => {
        ...
        let queuechairman = this.props.queueDetail.queuechairman
        let enableAgentLogin = this.props.queueDetail.enable_agent_login

        if ((queueMemberRole === 'chairman') && (currentUserName === queuechairman)) {
